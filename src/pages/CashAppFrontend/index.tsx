...
export const CashAppFrontendPage: React.FC = () => {
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-agrandir items-center justify-start mx-auto pb-[3px] w-full">
        <div className="h-[1442px] md:h-[2305px] sm:h-[846px] md:px-5 relative w-full">
          <div className="absolute h-[1085px] md:h-[2305px] sm:h-[846px] inset-x-[0] mx-auto top-[0] w-full">
            <div className="absolute bg-black-900 flex md:flex-col flex-row md:gap-5 inset-x-[0] items-end justify-start mx-auto p-[18px] top-[0] w-full">
              <Img
                ...
                alt="alarm"
              />
              <div className="flex md:flex-1 md:flex-col flex-row gap-5 items-center justify-start mb-[624px] md:ml-[0] ml-[210px] md:mt-0 mt-4 w-auto md:w-full cursor-pointer ">
                <a
                  href="javascript:"
            ...
            <div className="absolute flex flex-col h-full inset-[0] items-center justify-center m-auto py-0.5 w-full">
              <div className="h-[692px] md:h-[842px] mb-[389px] relative w-full">
                ...
                <div className="absolute bottom-[3%] flex md:flex-col flex-row md:gap-5 inset-x-[0] items-center justify-start mx-auto w-[92%]">
                  <div className="flex flex-col items-center justify-start w-auto">
                    <div className="flex flex-col items-center justify-start w-auto">
                      <div className="flex flex-row gap-5 items-center justify-start w-auto">
                        <Button className="bg-[#000000] border border-[##FFFFFF] border-solid cursor-pointer flex items-center justify-center min-w-[170px] px-6 py-[13px] rounded-[7px]">
                          <div
                          ...
                          >
                            ...
                            <div className="font-agrandir font-extrabold sm:px-5 text-[#FFFFFF] text-center text-xs tracking-[0.50px] uppercase">
                              APP STORE
                            </div>
                          </div>
                        </Button>
                        ...
                        <Button className="bg-[#000000] border border-[##FFFFFF] border-solid cursor-pointer flex items-center justify-center min-w-[170px] px-6 py-[13px] rounded-[7px]">
                          ...
                          <div className="font-agrandir font-extrabold text-[#FFFFFF] text-center text-xs tracking-[0.50px] uppercase">
                            GOOGLE PLAY
                          </div>
                        </Button>
                      </div>
                  ...
                  <Img
                    className="w-[30px] h-[30px] md:ml-[0] ml-[253px] rounded-full text-align-center hover:scale-110 cursor-pointer"
                  ...
                  <div className="flex gap-[30px] h-6 items-center justify-start md:ml-[0] ml-[35px] w-[126px] cursor-pointer">
                    <ul>
                      <svg
                        width="25"
                        height="24"
          ...
          <FirstPage className="absolute bg-gray-100 bottom-[0] md:h-[498px] sm:h-[626px] h-[750px] inset-x-[0] mx-auto pt-[116px] w-full" />
        </div>
        <div className="bg-green-A700 md:h-[407px] sm:h-[640px] h-[750px] pr-[68px] md:px-5 relative w-full">
          <SecondComponent className="md:h-[407px] sm:h-[640px] h-[750px] my-auto w-[96%] md:w-full" />
          <Img
          ...
          <Img
            ...
            alt="bankingcolumn"
          />
          <div className="absolute flex flex-col gap-2 h-max inset-y-[0] items-start justify-start left-[16%] my-auto w-[352px] h-[141px]">
            <Text
        ...
        <div className="bg-black-900 md:h-[1773px] h-[750px] md:px-5 relative w-full">
          ...
          <div className="absolute flex flex-col gap-3.5 items-start justify-start left-[15%] pb-4 pr-4 top-[30%]  w-[352px] h-[141px]">
            <Text
...
export default CashAppFrontendPage;
